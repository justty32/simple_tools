"""llm_tool_roundtrip.py — 串流、思考與 base_tools 呼叫的 worked example。

    uv run python examples/llm_tool_roundtrip.py                # 預設模型
    uv run python examples/llm_tool_roundtrip.py lm-gemma-4-e4b # 換模型
