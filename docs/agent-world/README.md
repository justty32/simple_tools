...
[FreePy Agent Machine](../../freepy/agent_machine/README.md)。
...
瀏覽器入口是 [index.html](index.html)。較貼近目前程式碼的實作規劃仍在 `freepy/agentfs/`、`freepy/memory_tools/` 與 `freepy/agentloop/ROUNDS.md`。
