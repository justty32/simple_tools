...
- `shells`、`prototypes/exec_tools/discover.py`
- `prototypes/plan_shell.py`、`examples/llm_tool_roundtrip.py`

「已規劃」則是尚無對應實作或只有部分骨架：

- `docs/freepy/future/` 下的 agent runtime、communication、team、memory、introspection、agentfs
...
- [freepy IDEAS](../../../../freepy/notes/IDEAS.md)
- [freepy 工作筆記](../../../../freepy/notes/README.md)
